...
(function() {
    ...
    if ((window.location.pathname + window.location.search).replace("/discuss/topic/269455/?atprivatesupercoolsohaha", "") != (window.location.pathname + window.location.search)) {
        ...
        $(".linkst").after(`<div id="p2714321"class="blockpost roweven firstpost"><a name="post-2714321"></a><div class="box"><div class="box-head"><span class="conr">${info.number}</span><a href="#">${info.time}</a></div><div class="box-content"><div class="postleft"><dl><dt><a class="black username"href="/users/${info.username}/">${info.username}</a></dt><dd class="postavatar"><a href="/users/${info.username}/"><img src="https://placeholdit.imgix.net/~text?txtsize=25&txt=No%20Image%20Support&w=90&h=90"width="90"height="90"></a></dd>Super ATer of awesomeness<br></dl></div><div class="postright"><h3>The AT GitHub</h3><div class="postmsg"><div class="post_body_html">Welp.Its pretty simple.With using all of our Super Programming Powers™I decided to make a GitHub Org so all of us ATers can work together on projects to improve scratch,add features,or just make random things.Ask to be added here,and go to the repo<a href="https://github.com/ScratchAT">here</a>there is also a gitter<a href="https://gitter.im/Scratch-AT/Lobby">here</a></div></div></div><div class="clearer"></div><div class="postfootleft"></div><div class="postfootright"><ul><li class="postquote">|<a onclick="return copy_paste('p2714321');"href="#reply"title="Insert a quotation of this post in your reply.">Quote</a></li></ul></div></div></div></div>`);
    }
